...
-   Alcuni reparti. Confrontati con la Neurochirurgia che ha il tasso di infezioni più vicino a quello dell'intero ospedale

Nell'analisi multivariata quindi inseriamo
...
Se questo è vero per le procedure invasive nel loro insieme, potrebbe essere diverso per ciascuna procedura presa singolarmente. Quindi forse ha senso fare la regressione per ogni tipo di rpocedura, per vedere quali sono correlate, ma ha senso farlo anche in una analisi multivariabile per escludere l'ipotesi confounder.

Questa è l'univariata per ciascuna procedura rispetto al resto del campione
...
Alcune hanno odds ratio altissimi. Ma farei la multivariabile per
...
A meno che non abbia senso accorparne alcuna perchè sono simili.

Per vedere quanti pazienti hanno subito queste procedure si può vedere questa tabella descrittiva. Alcune hanno talmente pochi casi che forse si possono togliere dall'analisi.
